...
// stolen from here: https://www.codeproject.com/Articles/36747/Quick-and-Dirty-HexDump-of-a-Byte-Array

namespace PaulasCadenza.Utilities
{
	public static class HexDump
	{
		public static string Process(byte[] bytes, int bytesPerLine = 16)
		{
